...
| `percent`        | done     | `Existing`           | C++11   | C++11以降 | なし       | header-only + test               | value       | percent小値型                                | `ket::percent::Percent`, `ket::percent::Percent::TryFromRatio`, `ket::percent::Percent::FromPercentClamped`                      | basis points、範囲外/NaN は失敗、clamp は0/100%          | 0/100、負値、>100、ratio、rounding      | 内部表現は0..10000               |
